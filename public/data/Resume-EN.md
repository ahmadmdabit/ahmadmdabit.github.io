...
- **Architectures & Patterns:** Microservices, Clean Architecture, Domain-Driven Design (DDD), CQRS, N-Tier, MVVM, Zero-Allocation Architecture, Fine-Grained Reactivity, List Virtualization
- **.NET Ecosystem:** ASP.NET Core, .NET Framework, ASP.NET MVC, Web API, Entity Framework Core, WCF, WPF, WinForms, System.CommandLine, P/Invoke / LibraryImport, AutoMapper, MediatR, Mediator.SourceGenerator, Polly, FluentValidation, CommunityToolkit.Mvvm, Hangfire
...
- **Cloud, DevOps & Infrastructure:** Microsoft Azure (Virtual Machines, Storage, Functions, Blobs, File Share, Tables), Docker, MinIO, Heroku, CI/CD, Git, GitHub, SVN, Microsoft IIS, Apache HTTP Server, Microsoft Server, Ubuntu Server, Serilog, ZLogger, OpenTelemetry, VirtualBox, Windows Kernel API
...
- **AI, Search & API Integration:** Claude, GPT, Google Gemini AI, YouTube API, GitHub Copilot, Ollama, OpenRouter, ElasticSearch, Lucene, Chrome Extensions, Prompt Engineering, Context Engineering, AI Orchestration, Cline
...
### [RepoAIfy](https://github.com/ahmadmdabit/RepoAIfy)
...
### [AI Utils Extension](https://github.com/ahmadmdabit/ai-utils-extension)
...
- **Azure Data Engineer Associate** (Microsoft) - 2023 - [Reference]
- **A+** (CompTIA) - 2010
